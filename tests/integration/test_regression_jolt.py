...
def test_jolt_regression_vs_classification():
    """Test JOLT with regression vs classification datasets."""
    ...
    reg_task_type, _ = detect_task_type(
        dataset=regression_dataset, y=y_reg, manual_override="regression"
    )
    cls_task_type, _ = detect_task_type(
...
def main():
    """Run the JOLT regression test."""
    test_jolt_regression_vs_classification()
