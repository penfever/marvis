...
def test_load_embeddings_with_limit():
    ...
    try:
        ...
        print(
            f"Loaded shapes - Train: {train_embeddings.shape}, Val: {val_embeddings.shape}, Test: {test_embeddings.shape}"
        )
        ...
        if max_test_samples is not None:
            ...
            print(
                f"Limited shapes - Train: {train_embeddings.shape}, Val: {val_embeddings_limited.shape}, Test: {test_embeddings_limited.shape}"
            )
            print(
        ...
        print(
            f"Multi-ensemble shapes - Val: {val_embeddings_limited.shape}, Test: {test_embeddings_limited.shape}"
        )
        print(
            f"Loaded embeddings with limits - Val: {val_to_load}/{val_count}, Test: {test_to_load}/{test_count}"
        )
