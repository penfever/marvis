...
def main():
    ...
    for shot in shots:
        for seed in seeds:
            print("-------------------------------")
            print(
                "model={}, dataset=wine_quality, shot={}, seed={}".format(
                    args.llm_type, shot, seed
                )
            )
            print("-------------------------------")
            config_args = option_parser.parse_args(
                args=[
                    "--experiment_name",
                    "wine_quality_shot_{}_seed_{}_{}".format(shot, seed, args.llm_type),
                    "--data_path",
                    "./data/wine_quality.csv",
                    "--output_dir",
                    "./experiments/multi_target_prediction/output",
                    "--mode",
                    "sample_logpy",
                    "--seed",
                    seed,
