            ...
            if filename.isdigit():
                ...
                try:
                    ...
                    dataset_name = metadata.get(
                        "dataset_name", metadata.get("dataset", f"task_{task_id}")
                    )
                    dataset_id = metadata.get("dataset_id")
                    target_attr = (
                        metadata.get("target_variable", {}).get("name")
                        if isinstance(metadata.get("target_variable"), dict)
                        else metadata.get("target_attribute")
                    )

                    # Determine task type
                    task_type = metadata.get("task_type", "classification")
                    if (
                        "regression" in str(metadata).lower() or task_id > 361000
                    ):  # Regression tasks typically have higher IDs
                    ...
                    logger.debug(
                        f"Discovered task {task_id}: {dataset_name} ({task_type})"
                    )
...
def _create_openml_mapping() -> Dict[int, Dict[str, Any]]:
    ...
    mapping = {}
    logger.info(
        "Starting with empty mapping - only using OpenML API for task resolution"
    )
        ...
        try:
            ...
            for task_id in cc18_task_ids:
                try:
                    ...
                    logger.debug(
                        f"Added CC18 task {task_id}: {dataset.name} (dataset_id: {task.dataset_id})"
                    )
                except Exception as e:
                    logger.warning(
        ...
        try:
            ...
            for task_id in regression_task_ids:
                try:
                    ...
                    logger.debug(
                        f"Added regression task {task_id}: {dataset.name} (dataset_id: {task.dataset_id})"
                    )
                except Exception as e:
                    logger.warning(
...
def _get_fallback_mapping() -> Dict[int, Dict[str, Any]]:
    ...
    return {
        ...
        23: {
            ...
            "num_classes": 3,
            "num_features": 9,
            "target_attribute": "Contraceptive_method_used",
        },
        28: {
            "dataset_id": 28,
        ...
        1475: {
            "dataset_id": 1475,
            "dataset_name": "first-order-theorem",
            "num_classes": 6,
            "num_features": 51,
            "target_attribute": "class",
        },
        ...
        361086: {
            ...
            "task_type": "regression",
            "target_attribute": "AverageTotalPayments",
        },
        361087: {
            "dataset_id": 44147,
            "dataset_name": "MiamiHousing2016",
            "task_type": "regression",
            "target_attribute": "SALEPRC",
        },
        361088: {
            "dataset_id": 44148,
            "dataset_name": "superconduct",
            "task_type": "regression",
            "target_attribute": "criticaltemp",
        },
        361099: {
            "dataset_id": 44063,
        ...
        361103: {
            ...
            "task_type": "regression",
            "target_attribute": "PM.sub.10..sub..particulate.matter..Hourly.measured.",
        },
        361104: {
            "dataset_id": 44069,
            "dataset_name": "SGEMM_GPU_kernel_performance",
            "task_type": "regression",
            "target_attribute": "Run1",
        },
        363370: {
            "dataset_id": 46657,
            "dataset_name": "google_qa_answer_type_reason_explanation",
            "task_type": "regression",
            "target_attribute": "answer_type_reason_explanation",
        },
        363371: {
            "dataset_id": 46658,
            "dataset_name": "google_qa_question_type_reason_explanation",
            "task_type": "regression",
            "target_attribute": "question_type_reason_explanation",
        },
        363372: {
            "dataset_id": 46663,
        ...
        363376: {
            ...
            "task_type": "regression",
            "target_attribute": "log_shares",
        },
        363377: {
            "dataset_id": 46660,
            "dataset_name": "mercari_price_suggestion100K",
            "task_type": "regression",
            "target_attribute": "log_price",
        },
        363387: {
            "dataset_id": 46695,
            "dataset_name": "convai2_inferred",
            "task_type": "regression",
            "target_attribute": "ternary_score",
        },
        363388: {
            "dataset_id": 46696,
        ...
        363391: {
            ...
            "task_type": "regression",
            "target_attribute": "toxicity",
        },
        363394: {
            "dataset_id": 46710,
            "dataset_name": "UCC",
            "task_type": "regression",
            "target_attribute": "hostile_confidence",
        },
        363396: {
            "dataset_id": 46621,
            "dataset_name": "Wheat",
            "task_type": "regression",
            "target_attribute": "Stability",
        },
        363397: {
            "dataset_id": 46638,
            "dataset_name": "Phenotype_202",
            "task_type": "regression",
            "target_attribute": "Survive_time",
        },
        363399: {
            "dataset_id": 46586,
            "dataset_name": "QSAR_Bioconcentration_regression",
            "task_type": "regression",
            "target_attribute": "logBCF",
        },
        363417: {
            "dataset_id": 46612,
            "dataset_name": "heart_failure_clinical_records",
            "task_type": "regression",
            "target_attribute": "platelets",
        },
        363418: {
            "dataset_id": 46613,
            "dataset_name": "infrared_thermography_temperature",
            "task_type": "regression",
            "target_attribute": "aveOralF",
        },
        363426: {
            "dataset_id": 46717,
        ...
        363431: {
            ...
            "task_type": "regression",
            "target_attribute": "PROPERTY_CRIME_TOTALS",
        },
        363432: {
            "dataset_id": 46725,
            "dataset_name": "Crime_Data_from_2010",
            "task_type": "regression",
            "target_attribute": "Victim_Age",
        },
        363433: {
            "dataset_id": 46724,
            "dataset_name": "cybersecurity_attacks",
            "task_type": "regression",
            "target_attribute": "Anomaly_Scores",
        },
        363434: {
            "dataset_id": 46726,
            "dataset_name": "climate_change_impact_on_agriculture_2024",
            "task_type": "regression",
            "target_attribute": "Economic_Impact_Million_USD",
        },
        363435: {
            "dataset_id": 46727,
            "dataset_name": "all-natural-disasters-19002021-eosdis",
            "task_type": "regression",
            "target_attribute": "Total_Affected",
        },
        363436: {
            "dataset_id": 46728,
            "dataset_name": "climate_change_dataset2020-2024",
            "task_type": "regression",
            "target_attribute": "Sea_Surface_Temp_degC",
        },
        363437: {
            "dataset_id": 46729,
            "dataset_name": "climate_insights_dataset",
            "task_type": "regression",
            "target_attribute": "Sea_Level_Rise",
        },
        363438: {
            "dataset_id": 46730,
            "dataset_name": "reddit_opinion_climate_change",
            "task_type": "regression",
            "target_attribute": "post_thumbs_ups",
        },
        363439: {
            "dataset_id": 46731,
            "dataset_name": "temperature_emissions_environmental_trends_2000_2024",
            "task_type": "regression",
            "target_attribute": "Forest_Area_pct",
        },
        363440: {
            "dataset_id": 46732,
            "dataset_name": "pakistan_hunger_data",
            "task_type": "regression",
            "target_attribute": "Children_Underweight",
        },
        363442: {
            "dataset_id": 46734,
...
def impute_task_id_from_dataset_name(dataset_name: str) -> Optional[int]:
    ...
    for task_id, info in mapping.items():
        info_name_clean = (
            info["dataset_name"].lower().replace("-", "_").replace(" ", "_")
        )
        if info_name_clean == dataset_name_clean:
            logger.debug(
                f"Found fuzzy match: {dataset_name} -> {info['dataset_name']} -> task_id {task_id}"
            )
            return task_id
