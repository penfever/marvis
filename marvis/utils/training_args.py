...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--embedding_size", type=int, default=1000, help="Size of the embeddings"
    )
    parser.add_argument(
...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--save_steps", type=int, default=None, help="Save model every N steps"
    )
    parser.add_argument(
        "--save_total_limit",
        type=int,
...
def add_learning_rate_scheduler_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--lr_power", type=float, default=1.0, help="Power for polynomial scheduler"
    )
    parser.add_argument(
        "--lr_num_cycles",
        type=float,
...
def add_wandb_args(
    parser: argparse.ArgumentParser, default_project: str = "marvis-training"
):
...
def create_common_parser(
    description: str, default_wandb_project: str = "marvis-training"
